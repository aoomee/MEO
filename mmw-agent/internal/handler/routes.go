...
func RegisterChildRoutes(mux *http.ServeMux, apiHandler *APIHandler, manageHandler *ManageHandler, warpHandler *WarpHandler) {
	...
	mux.HandleFunc(constants.PathChildForwardApply, manageHandler.HandleForwardApply)
	mux.HandleFunc(constants.PathChildForwardStatus, manageHandler.HandleForwardStatus)
	...
	mux.HandleFunc(constants.PathChildGuardAttest, manageHandler.HandleActionGuardAttest)
	mux.HandleFunc(constants.PathChildGuardStatus, manageHandler.HandleActionGuardStatus)
	mux.HandleFunc(constants.PathChildGuardConsume, manageHandler.HandleActionGuardConsume)
